...
class RulesViewController: UIViewController {
    ...
    private lazy var rulesLabel: UILabel = {
        ...
        label.textColor = .welcomeBackgroundColor
        label.textAlignment = .center
        return label
    }()
    ...
    private func setupViews() {
        view.backgroundColor = UIColor(red: 0.191, green: 0.205, blue: 0.271, alpha: 1)
...
//            rulesTextLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
